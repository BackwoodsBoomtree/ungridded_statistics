...
input_dirs <- list.dirs("G:/GOSAT_ACOS/extracted/Australia_NZ", full.names = TRUE, recursive = TRUE)
out_tag    <- "_2009-2020_xco2"
out_dir    <- "G:/GOSAT_ACOS/extracted/Australia_NZ_stats"
years      <- c(2009:2020)
time       <- "month"
variable   <- "xco2"
filters    <- NULL
