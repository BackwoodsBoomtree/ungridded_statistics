...
input_files <- list.files("G:/TROPOMI/esa/extracted/ebf/GH-Ank", pattern = "*.nc", full.names = TRUE, recursive = TRUE)
out_name    <- "GH-Ank_TROPOSIF_L2B_2019-2021_sifd_mean_timeseries_monthly"
out_dir     <- "G:/Africa/GH_Ank/tropomi/"
years       <- c(2019:2021)
time        <- "month"
